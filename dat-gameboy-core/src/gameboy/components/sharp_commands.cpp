...
namespace dat
{
	...
	void s_SharpSM83::run_02() { load(address_of(BC.get()), A); }						// LD [BC], A
	...
	void s_SharpSM83::run_0A() { load(A, address_of(BC.get())); }						// LD A, [BC]
	...
	void s_SharpSM83::run_12() { load(address_of(DE.get()), A); }						// LD [DE], A
	...
	void s_SharpSM83::run_1A() { load(A, address_of(DE.get())); }						// LD A, [DE]
	...
	void s_SharpSM83::run_22() { load(address_of(HL.get()), A); HL.get()++; }			// LD [HL+], A
	...
	void s_SharpSM83::run_2A() { load(A, address_of(HL.get())); HL.get()++; }			// LD A, [HL+]
	...
	void s_SharpSM83::run_32() { load(address_of(HL.get()), A); HL.get()--; }			// LD [HL-], A
	void s_SharpSM83::run_33() { inc(SP.get()); }										// INC SP
	void s_SharpSM83::run_34() { inc(address_of(HL.get())); }							// INC [HL]
	void s_SharpSM83::run_35() { dec(address_of(HL.get())); }							// DEC [HL]
	void s_SharpSM83::run_36() { load(address_of(HL.get()), fetch_byte()); }			// LD [HL], n8
	...
	void s_SharpSM83::run_3A() { load(A, address_of(HL.get())); HL.get()--; }			// LD A, [HL-]
	...
	void s_SharpSM83::run_46() { load(BC.get_msb(), address_of(HL.get())); }			// LD B, [HL]
	...
	void s_SharpSM83::run_4E() { load(BC.get_lsb(), address_of(HL.get())); }			// LD C, [HL]
	...
	void s_SharpSM83::run_56() { load(DE.get_msb(), address_of(HL.get())); }			// LD D, [HL]
	...
	void s_SharpSM83::run_5E() { load(DE.get_lsb(), address_of(HL.get())); }			// LD E, [HL]
	...
	void s_SharpSM83::run_66() { load(HL.get_msb(), address_of(HL.get())); }			// LD H, [HL]
	...
	void s_SharpSM83::run_6E() { load(HL.get_lsb(), address_of(HL.get())); }			// LD L, [HL]
	void s_SharpSM83::run_6F() { load(HL.get_lsb(), A); }								// LD L, A

	void s_SharpSM83::run_70() { load(address_of(HL.get()), BC.get_msb()); }			// LD [HL], B
	void s_SharpSM83::run_71() { load(address_of(HL.get()), BC.get_lsb()); }			// LD [HL], C
	void s_SharpSM83::run_72() { load(address_of(HL.get()), DE.get_msb()); }			// LD [HL], D
	void s_SharpSM83::run_73() { load(address_of(HL.get()), DE.get_lsb()); }			// LD [HL], E
	void s_SharpSM83::run_74() { load(address_of(HL.get()), HL.get_msb()); }			// LD [HL], H
	void s_SharpSM83::run_75() { load(address_of(HL.get()), HL.get_lsb()); }			// LD [HL], L
	void s_SharpSM83::run_76() { halt(); }												// HALT
	void s_SharpSM83::run_77() { load(address_of(HL.get()), A); }						// LD [HL], A
	...
	void s_SharpSM83::run_7E() { load(A, address_of(HL.get())); }						// LD A, [HL]
	...
	void s_SharpSM83::run_86() { add(A, address_of(HL.get())); }						// ADD A, [HL]
	...
	void s_SharpSM83::run_8E() { adc(A, address_of(HL.get())); }						// ADC A, [HL]
	...
	void s_SharpSM83::run_96() { sub(A, address_of(HL.get())); }						// SUB A, [HL]
	...
	void s_SharpSM83::run_9E() { sbc(A, address_of(HL.get())); }						// SBC A, [HL]
	...
	void s_SharpSM83::run_A6() { _and(A, address_of(HL.get())); }						// AND A, [HL]
	...
	void s_SharpSM83::run_AE() { _xor(A, address_of(HL.get())); }						// XOR A, [HL]
	...
	void s_SharpSM83::run_B6() { _or(A, address_of(HL.get())); }						// OR A, [HL]
	...
	void s_SharpSM83::run_BE() { cp(address_of(HL.get())); }							// CP A, [HL]
	...
	void s_SharpSM83::run_EA() { load(address_of(fetch_word()), A); }					// LD [a16], A
	...
	void s_SharpSM83::run_FA() { load(A, address_of(fetch_word())); }					// LD A, [a16]
...
namespace dat
{
	...
	void s_SharpSM83::run_cb_06() { rlc(address_of(HL.get())); }						// RLC [HL]
	...
	void s_SharpSM83::run_cb_0E() { rrc(address_of(HL.get())); }						// RRC [HL]
	...
	void s_SharpSM83::run_cb_16() { rl(address_of(HL.get())); }							// RL [HL]
	...
	void s_SharpSM83::run_cb_1E() { rr(address_of(HL.get())); }							// RR [HL]
	...
	void s_SharpSM83::run_cb_26() { sla(address_of(HL.get())); }						// SLA [HL]
	...
	void s_SharpSM83::run_cb_2E() { sra(address_of(HL.get())); }						// SRA [HL]
	...
	void s_SharpSM83::run_cb_36() { swap(address_of(HL.get())); }						// SWAP [HL]
	...
	void s_SharpSM83::run_cb_3E() { srl(address_of(HL.get())); }						// SRL [HL]
	...
	void s_SharpSM83::run_cb_46() { bit(address_of(HL.get()), 0); }						// BIT 0, [HL]
	...
	void s_SharpSM83::run_cb_4E() { bit(address_of(HL.get()), 1); }						// BIT 1, [HL]
	...
	void s_SharpSM83::run_cb_56() { bit(address_of(HL.get()), 2); }						// BIT 2, [HL]
	...
	void s_SharpSM83::run_cb_5E() { bit(address_of(HL.get()), 3); }						// BIT 3, [HL]
	...
	void s_SharpSM83::run_cb_66() { bit(address_of(HL.get()), 4); }						// BIT 4, [HL]
	...
	void s_SharpSM83::run_cb_6E() { bit(address_of(HL.get()), 5); }						// BIT 5, [HL]
	...
	void s_SharpSM83::run_cb_76() { bit(address_of(HL.get()), 6); }						// BIT 6, [HL]
	...
	void s_SharpSM83::run_cb_7E() { bit(address_of(HL.get()), 7); }						// BIT 7, [HL]
	...
	void s_SharpSM83::run_cb_86() { res(address_of(HL.get()), 0); }						// RES 0, [HL]
	...
	void s_SharpSM83::run_cb_8E() { res(address_of(HL.get()), 1); }						// RES 1, [HL]
	...
	void s_SharpSM83::run_cb_96() { res(address_of(HL.get()), 2); }						// RES 2, [HL]
	...
	void s_SharpSM83::run_cb_9E() { res(address_of(HL.get()), 3); }						// RES 3, [HL]
	...
	void s_SharpSM83::run_cb_A6() { res(address_of(HL.get()), 4); }						// RES 4, [HL]
	...
	void s_SharpSM83::run_cb_AE() { res(address_of(HL.get()), 5); }						// RES 5, [HL]
	...
	void s_SharpSM83::run_cb_B6() { res(address_of(HL.get()), 6); }						// RES 6, [HL]
	...
	void s_SharpSM83::run_cb_BE() { res(address_of(HL.get()), 7); }						// RES 7, [HL]
	...
	void s_SharpSM83::run_cb_C6() { set(address_of(HL.get()), 0); }						// SET 0, [HL]
	...
	void s_SharpSM83::run_cb_CE() { set(address_of(HL.get()), 1); }						// SET 1, [HL]
	...
	void s_SharpSM83::run_cb_D6() { set(address_of(HL.get()), 2); }						// SET 2, [HL]
	...
	void s_SharpSM83::run_cb_DE() { set(address_of(HL.get()), 3); }						// SET 3, [HL]
	...
	void s_SharpSM83::run_cb_E6() { set(address_of(HL.get()), 4); }						// SET 4, [HL]
	...
	void s_SharpSM83::run_cb_EE() { set(address_of(HL.get()), 5); }						// SET 5, [HL]
	...
	void s_SharpSM83::run_cb_F6() { set(address_of(HL.get()), 6); }						// SET 6, [HL]
	...
	void s_SharpSM83::run_cb_FE() { set(address_of(HL.get()), 7); }						// SET 7, [HL]
