...
namespace dat
{
	void setup_opengl_windowing(Window& window, const WindowProperties& properties, const GraphicsSpecification& specification)
	{
#ifdef DAT_DEBUG
		...
		GLFWwindow* glfwWindow = window.get_handle();
